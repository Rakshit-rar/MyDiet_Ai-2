...
st.markdown("""
<style>
/* Modern Professional Background - Soft Grey-Blue */
[data-testid="stAppViewContainer"] {
    background-color: #f8fafc !important;
    color: #1e293b !important;
}

/* Clean Professional Cards with Subtle Depth */
.stMetric, .stAlert, .stFileUploader, div[data-testid="column"], .stTabs {
...
p, label, .stMarkdown, [data-testid="stMetricLabel"] {
