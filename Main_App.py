...
/* Glassmorphism Cards for Metrics and Sections */
.stMetric, .stAlert, .stFileUploader, div[data-testid="column"] {
...
/* Fix for Upload Section Visibility */
...
/* Consistent Buttons (No more black/white jumping) */
.stButton > button {
...
/* Ensure headers and text remain dark/readable */
